...
class CE_Net_(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        ...
        self.firstconv = resnet.conv1#nn.Conv2d(3, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
    ...
    def forward(self, input):
        ...
        # Decoder
        # e4 = pad(e4,e3)
        d4 = pad(self.decoder4(e4),e3) + e3
        # d4 = pad(d4,e2)
        d3 = pad(self.decoder3(d4),e2) + e2
        # d3 = pad(d3,e1)
        d2 = pad(self.decoder2(d3),e1) + e1
